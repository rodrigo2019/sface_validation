...
class SFace:
    def __init__(self, model_path, dis_type=0, backend_id=0, target_id=0):
        ...
        self._disType = dis_type  # 0: cosine similarity, 1: Norm-L2 distance
    ...
    def match(self, image1, face1, image2, face2):
        ...
        if self._disType == 0:  # COSINE
            ...
            print("Cosine score: {}".format(cosine_score))
